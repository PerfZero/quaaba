...
export default function FoodPage() {
  ...
  const data: Food[] = [
    { key: '1', name: 'Завтрак', status: 'Активный' },
    { key: '2', name: 'Обед', status: 'Активный' },
    { key: '3', name: 'Ужин', status: 'Активный' },
    { key: '4', name: 'Полупансион', status: 'Активный' },
    { key: '5', name: 'Полный пансион', status: 'Активный' },
    { key: '6', name: 'Все включено', status: 'Активный' },
    { key: '7', name: 'Ультра все включено', status: 'Активный' },
    { key: '8', name: 'Без питания', status: 'Неактивный' },
    { key: '9', name: 'Только завтрак', status: 'Активный' },
    { key: '10', name: 'Шведский стол', status: 'Активный' },
  ];
    ...
    <Flex vertical gap={16}>
      <Flex justify="space-between" align="center" wrap="wrap" gap={16}>
        <Flex align="center" gap={12}>
          <Title level={2} style={{ margin: 0 }}>Питание</Title>
          <Tag>{data.length}</Tag>
        </Flex>
