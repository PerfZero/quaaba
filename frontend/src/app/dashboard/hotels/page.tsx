...
export default function HotelsPage() {
  ...
  const data: Hotel[] = [
    { key: '1', name: 'Rixos Almaty', photo: '', status: 'Активный' },
    { key: '2', name: 'The Ritz-Carlton Almaty', photo: '', status: 'Активный' },
    { key: '3', name: 'Ramada Plaza Astana', photo: '', status: 'Активный' },
    { key: '4', name: 'Radisson Hotel Astana', photo: '', status: 'Активный' },
    { key: '5', name: 'Hilton Almaty', photo: '', status: 'Активный' },
    { key: '6', name: 'Kazakhstan Hotel', photo: '', status: 'Активный' },
    { key: '7', name: 'Grand Park Esil', photo: '', status: 'Неактивный' },
    { key: '8', name: 'DoubleTree by Hilton', photo: '', status: 'Активный' },
    { key: '9', name: 'Rahat Palace', photo: '', status: 'Активный' },
    { key: '10', name: 'Kazzhol Hotel', photo: '', status: 'Активный' },
  ];
    ...
    <Flex vertical gap={16}>
      <Flex justify="space-between" align="center" wrap="wrap" gap={16}>
        <Flex align="center" gap={12}>
          <Title level={2} style={{ margin: 0 }}>Отели</Title>
          <Tag>{data.length}</Tag>
        </Flex>
