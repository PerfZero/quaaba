...
import { Typography, Flex, Input, Button, Space, Tag, Segmented, Table, Badge, Image } from 'antd';
...
export default function TransportPage() {
  ...
  const data: Transport[] = [
    { key: '1', name: 'Автобус', description: 'Комфортабельный автобус на 50 мест', photo: '', status: 'Активный' },
    { key: '2', name: 'Микроавтобус', description: 'Микроавтобус на 20 мест', photo: '', status: 'Активный' },
    { key: '3', name: 'Легковой автомобиль', description: 'Седан бизнес-класса', photo: '', status: 'Активный' },
    { key: '4', name: 'Минивэн', description: 'Семейный минивэн на 7 мест', photo: '', status: 'Активный' },
    { key: '5', name: 'Железнодорожный транспорт', description: 'Поезд дальнего следования', photo: '', status: 'Активный' },
    { key: '6', name: 'Авиаперелет', description: 'Регулярные рейсы', photo: '', status: 'Активный' },
    { key: '7', name: 'Трансфер', description: 'Трансфер до отеля', photo: '', status: 'Неактивный' },
    { key: '8', name: 'Аренда автомобиля', description: 'Аренда с водителем', photo: '', status: 'Активный' },
    { key: '9', name: 'Такси', description: 'Заказ такси', photo: '', status: 'Активный' },
    { key: '10', name: 'Трансфер VIP', description: 'VIP трансфер', photo: '', status: 'Активный' },
  ];
    ...
    <Flex vertical gap={16}>
      <Flex justify="space-between" align="center" wrap="wrap" gap={16}>
        <Flex align="center" gap={12}>
          <Title level={2} style={{ margin: 0 }}>Транспорт</Title>
          <Tag>{data.length}</Tag>
        </Flex>
