...
export default function BanksPage() {
  ...
  const data: Bank[] = [
    { key: '1', name: 'АО "Kaspi Bank"', bic: 'CASPKZKA', status: 'Активный' },
    { key: '2', name: 'АО "Halyk Bank"', bic: 'HSBKKZKX', status: 'Активный' },
    { key: '3', name: 'АО "ForteBank"', bic: 'IRTYKZKA', status: 'Активный' },
    { key: '4', name: 'АО "Bank CenterCredit"', bic: 'KCJBKZKX', status: 'Активный' },
    { key: '5', name: 'АО "Jýsan Bank"', bic: 'TSESKZKA', status: 'Активный' },
    { key: '6', name: 'АО "Eurasian Bank"', bic: 'EURAKZKA', status: 'Активный' },
    { key: '7', name: 'АО "Altyn Bank"', bic: 'ALMNKZKA', status: 'Неактивный' },
    { key: '8', name: 'АО "Home Credit Bank"', bic: 'HOMRKZKA', status: 'Активный' },
    { key: '9', name: 'АО "Bank RBK"', bic: 'RBKSKZKA', status: 'Активный' },
    { key: '10', name: 'АО "First Heartland Jýsan Bank"', bic: 'FHBKKZKA', status: 'Активный' },
  ];
