...
export default function RoomsPage() {
  ...
  const data: Room[] = [
    { key: '1', name: 'Одноместный', status: 'Активный' },
    { key: '2', name: 'Двухместный', status: 'Активный' },
    { key: '3', name: 'Трехместный', status: 'Активный' },
    { key: '4', name: 'Четырехместный', status: 'Активный' },
    { key: '5', name: 'Семейный', status: 'Активный' },
    { key: '6', name: 'Люкс', status: 'Активный' },
    { key: '7', name: 'Президентский', status: 'Активный' },
    { key: '8', name: 'Стандарт', status: 'Неактивный' },
    { key: '9', name: 'Улучшенный', status: 'Активный' },
    { key: '10', name: 'Эконом', status: 'Активный' },
  ];
    ...
    <Flex vertical gap={16}>
      <Flex justify="space-between" align="center" wrap="wrap" gap={16}>
        <Flex align="center" gap={12}>
          <Title level={2} style={{ margin: 0 }}>Комнаты</Title>
          <Tag>{data.length}</Tag>
        </Flex>
